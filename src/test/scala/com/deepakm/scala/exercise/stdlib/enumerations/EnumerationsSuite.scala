package com.deepakm.scala.exercise.stdlib.enumerations

import com.deepakm.scala.exercises.stdlib.enumerations.Planets
...
class EnumerationsSuite extends AnyFunSuite{
  test("Value assigns a numerical value to fields, indexed from 0: "){
  ...
  test("You can create an enumeration with your own index and your own Strings, in this exercise we will start" +
  ...
  test("Enumerations can be declared in one line if you are merely setting variables to Value: "){
